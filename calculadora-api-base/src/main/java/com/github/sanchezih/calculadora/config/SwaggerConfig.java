...
import com.github.sanchezih.calculadora.controller.CalculadoraCientificaController;
...
@Configuration
@EnableSwagger2
@ComponentScan(basePackageClasses = { CalculadoraAritmeticaController.class, CalculadoraCientificaController.class })
